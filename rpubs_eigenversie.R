...
unseen_trigram_tails            # -->"sos"   "the"   "eos"   "buy"   "house" "sell"  "paint"
...
get_prob_obs_bigram(bigrams_obs)        #       token           prob
                                        #1      the_house       0.3125
...
################### Deze functie nog verder uitwerken #############################
